...
const resources = {
  TR: {
    translation: {
      ...
      reservationForm: { badge: "Hızlı Rezervasyon", title: "Transferinizi planlayın", addReturn: "Dönüş transferi ekle", from: "Nereden", fromPlaceholder: "Havalimanı, otel veya adres seçin", to: "Nereye", toPlaceholder: "Havalimanı, otel veya adres seçin", date: "Tarih", time: "Saat", passengers: "Yolcu", passengerCount: "Yolcu", searchButton: "Araçları Gör", swap: "Adreslerin yerini değiştir", errors: { addressRequired: "Lütfen başlangıç ve varış adreslerini girin.", selectSuggestion: "Lütfen adresleri öneriler arasından seçin." } },
      customerSummary: {
  ...
  EN: {
    translation: {
      ...
      reservationForm: { badge: "Quick Reservation", title: "Plan your transfer", addReturn: "Add return transfer", from: "From", fromPlaceholder: "Select airport, hotel, or address", to: "To", toPlaceholder: "Select airport, hotel, or address", date: "Date", time: "Time", passengers: "Passengers", passengerCount: "Passenger(s)", searchButton: "See Vehicles", swap: "Swap addresses", errors: { addressRequired: "Please enter pickup and drop-off addresses.", selectSuggestion: "Please select both addresses from the suggestions." } },
      customerSummary: {
  ...
  RU: {
    translation: {
      ...
      reservationForm: { badge: "Быстрое бронирование", title: "Спланируйте трансфер", addReturn: "Добавить обратный трансфер", from: "Откуда", fromPlaceholder: "Аэропорт, отель или адрес", to: "Куда", toPlaceholder: "Аэропорт, отель или адрес", date: "Дата", time: "Время", passengers: "Пассажиры", passengerCount: "Пассажир(ы)", searchButton: "Показать автомобили", swap: "Поменять адреса местами", errors: { addressRequired: "Введите адреса отправления и назначения.", selectSuggestion: "Выберите оба адреса из предложенных вариантов." } },
      customerSummary: {
