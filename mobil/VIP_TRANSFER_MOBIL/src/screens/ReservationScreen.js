...
export default function ReservationScreen({ navigation, route }) {
  ...
  async function handleCreateReservation() {
    ...
    try {
      ...
      let preview = null;
      try {
        preview = await getReservationPricePreview({
          reservationData,
          requiresAuth: canCreateAuthenticatedReservation,
        });
      } catch {
        // Rezervasyon endpointi fiyatı yeniden hesaplar; önizleme hatası işlemi engellemez.
      }
